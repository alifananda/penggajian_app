    ...
    <table class="table table-bordered table-striped mt-2">
        ...
        <?php $no=1; foreach($jabatan as $j) : ?>
            <tr>
                ...
                <!-- membuat format rupiah dengan number_format -->
                <!-- angka 0 bermaksud 0 angka di belakang koma -->
                ...
                <td>
                    <center>
                        ...
                        <a onclick="return confirm('Yakin Hapus')" class="btn btn-sm btn-danger" href="<?= base_url('admin/DataJabatan/deleteData/'.$j->id_jabatan) ?>"> 
